...
public class CftTestContainer extends TestContainer {

    public CftTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/cft/app.properties",
    ...
    public static class Common extends CftTestContainer {

        public static final CftTestContainer.Common INSTANCE = new CftTestContainer.Common();
